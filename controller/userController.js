...
export const createUser = async (req, res) => {
  ...
  try {
    ...
    const createdUserExist = await pool.query(userExist, [
      email
    ]);
    if (createdUserExist.rows.length===0) {
 ...
 const randomPassword = generateRandomPassword(8);
      ...
      const userInfoQuery = `INSERT INTO users (fullname,email,phone_no,password,role) values($1,$2,$3,$4,$5) RETURNING *`;
      // const billingQuery = `INSERT INTO billing (user_id,address,city,zip_code) values($1,$2,$3,$4)`;
      // const paymentQuery = `INSERT INTO payment (user_id,payment_details) values($1,$2)`;
      ...
      if (createdUser.rows.length > 0) {
        // const createBilling = await pool.query(billingQuery, [
        ...
        <body>
          <div class="container">
            ...
            <p>You can access your user portal by clicking the button below:</p>
            <a class="button" href="${process.env.USER_PORTAL_URL}">Access Your Portal</a>
